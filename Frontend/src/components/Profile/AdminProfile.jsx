...
const AdminProfile = () => {
  ...
  const validateForm = () => {
    ...
    if (profileData.description.length > 500) {
      errors.description = "Opis ne može biti duži od 500 znakova";
    }

    console.log("MOJI PROBLEMI: " + JSON.stringify(errors, null, 2));
    ...
    <div className="user-profile-wrapper">
      ...
      >
        ...
        <div style={{ alignItems: "right" }}>
          ...
          <button onClick={handleCancelClick} className="admin-edit-button">
      ...
      {profileData ? (
        <div>
                ...
                <SelectMui
                  ...
                  renderValue={(selectedGroups) => (
                    <span style={{ fontSize: "calc(16px + 3px)" }}>
                      ...
                      {selectedGroups.map((id) => userPreferences[id]).join(", ")}
                    </span>
                  )}
                >
          ...
          <div className="user-profile-detail">
            <label>Opis</label>
            <textarea
              style={{ height: "300px", width: "400px", marginBottom: "100px" }}
              type="text"
              readOnly={!isEditable}
